...
func (x *StringRequst) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StringRequst) ProtoMessage() {}

func (x *StringRequst) ProtoReflect() protoreflect.Message {
	mi := &file_string_proto_msgTypes[0]
...
// Deprecated: Use StringRequst.ProtoReflect.Descriptor instead.
func (*StringRequst) Descriptor() ([]byte, []int) {
	return file_string_proto_rawDescGZIP(), []int{0}
}

func (x *StringRequst) GetA() string {
	if x != nil {
		return x.A
	}
	return ""
...
func (x *StringRequst) GetB() string {
	if x != nil {
		return x.B
	}
	return ""
...
var file_string_proto_rawDesc = []byte{
	...
	,
...
var file_string_proto_goTypes = []interface{}{
	(*StringRequst)(nil),   // 0: pb.StringRequst
	(*StringResponse)(nil), // 1: pb.StringResponse
}
var file_string_proto_depIdxs = []int32{
	0, // 0: pb.StringService.Concat:input_type -> pb.StringRequst
	0, // 1: pb.StringService.Diff:input_type -> pb.StringRequst
...
type StringServiceClient interface {
	Concat(ctx context.Context, in *StringRequst, opts ...grpc.CallOption) (*StringResponse, error)
	Diff(ctx context.Context, in *StringRequst, opts ...grpc.CallOption) (*StringResponse, error)
}
...
func (c *stringServiceClient) Concat(ctx context.Context, in *StringRequst, opts ...grpc.CallOption) (*StringResponse, error) {
...
func (c *stringServiceClient) Diff(ctx context.Context, in *StringRequst, opts ...grpc.CallOption) (*StringResponse, error) {
	out := new(StringResponse)
...
type StringServiceServer interface {
	Concat(context.Context, *StringRequst) (*StringResponse, error)
	Diff(context.Context, *StringRequst) (*StringResponse, error)
}
...
func (*UnimplementedStringServiceServer) Concat(context.Context, *StringRequst) (*StringResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Concat not implemented")
}
func (*UnimplementedStringServiceServer) Diff(context.Context, *StringRequst) (*StringResponse, error) {
...
func _StringService_Concat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StringServiceServer).Concat(ctx, req.(*StringRequst))
	}
...
func _StringService_Diff_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StringServiceServer).Diff(ctx, req.(*StringRequst))
	}
	return interceptor(ctx, in, info, handler)
}
